...
rapidjson::Document toValue(const JSONObjectReader& r) noexcept
{
...
JSONObjectWriter::JSONObjectWriter(const rapidjson::Value& o)
    : base{o}
    , components{score::AppComponents()}
    , strings{score::StringConstant()}
{
}
JSONObjectWriter::JSONObjectWriter(const JsonValue& o)
  : base{o.obj}
  , components{score::AppComponents()}
  , strings{score::StringConstant()}
{
