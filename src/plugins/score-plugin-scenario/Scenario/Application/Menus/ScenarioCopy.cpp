...
void
copySelected(JSONObjectReader& r, const Scenario_T& sm, CategorisedScenario& cs, QObject* parent)
{
...
void copyProcess(JSONObjectReader& r, const Process::ProcessModel& proc)
{
...
void copyWholeScenario(JSONObjectReader& r,
                       const Scenario::ProcessModel& sm)
{
