...
void copyBaseInterval(JSONObjectReader&, const IntervalModel&);

SCORE_PLUGIN_SCENARIO_EXPORT
void copySelectedScenarioElements(JSONObjectReader&, const Scenario::ProcessModel& sm);

SCORE_PLUGIN_SCENARIO_EXPORT
void copyWholeScenario(JSONObjectReader&, const Scenario::ProcessModel& sm);
...
SCORE_PLUGIN_SCENARIO_EXPORT
void copyProcess(JSONObjectReader&, const Process::ProcessModel&);
...
//        QObject* parent);
void
copySelectedScenarioElements(JSONObjectReader&, const BaseScenarioContainer& sm, QObject* parent);
